...
func NewClientConnection(conn net.Conn, handler httpstream.NewStreamHandler) (httpstream.Connection, error) {
	return NewClientConnectionWithPings(conn, handler, 0)
}
...
func NewClientConnectionWithPings(conn net.Conn, newStreamHandler httpstream.NewStreamHandler, pingPeriod time.Duration) (httpstream.Connection, error) {
...
// client.
func NewServerConnection(conn net.Conn, handler httpstream.NewStreamHandler) (httpstream.Connection, error) {
	return NewServerConnectionWithPings(conn, handler, 0)
}
