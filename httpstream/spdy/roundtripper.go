...
import (
	...
	"github.com/arangodb-managed/portforward-helper/internal/transport/netutil"
)
...
func NewRoundTripperWithConfig(cfg RoundTripperConfig) *SpdyRoundTripper {
	...
	return &SpdyRoundTripper{
		...
		newStreamHandler: cfg.NewStreamHandler,
	}
}
...
func (s *SpdyRoundTripper) NewConnection(resp *http.Response) (httpstream.Connection, error) {
	...
	return NewClientConnectionWithPings(s.conn, s.newStreamHandler, s.pingPeriod)
}
